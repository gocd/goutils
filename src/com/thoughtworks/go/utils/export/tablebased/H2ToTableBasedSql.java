...
public class H2ToTableBasedSql {
    ...
    private static List<String> TABLES = Arrays.asList("AGENTS", "ARTIFACTPLANS", "ARTIFACTPROPERTIESGENERATOR",
            "BUILDS", "BUILDSTATETRANSITIONS", "CHANGELOG", "ENVIRONMENTVARIABLES", "JOBAGENTMETADATA",
            "MATERIALS",
            "MODIFICATIONS", "MODIFIEDFILES", "NOTIFICATIONFILTERS", "OAUTHAUTHORIZATIONS", "OAUTHCLIENTS", "OAUTHTOKENS",
            "PIPELINELABELCOUNTS", "PIPELINEMATERIALREVISIONS", "PIPELINES", "PIPELINESELECTIONS", "PIPELINESTATES","PLUGINS",
            "PROPERTIES",
            "RESOURCES", "SERVERBACKUPS", "STAGEARTIFACTCLEANUPPROHIBITED", "STAGES", "USERS", "VERSIONINFOS");
